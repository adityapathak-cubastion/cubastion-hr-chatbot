...
def chunk_text(text, doc_id, chunk_size = 500):
    words = text.split()
...
dir_path = "C:/Users/AdityaPathak/Desktop/documentChat-Local/collectedDocs"
# dir_path = "C:/Users/AdityaPathak/Desktop/documentChat-Local/testDocs"
all_texts = []
all_docs_name = []
...
for doc_id, text in enumerate(all_texts):
    chunks, chunks_doc_ids = chunk_text(text, doc_id, 384) # can try 384 as well
