...
from takingQuery import answer_query
...
st.set_page_config(page_title = "HR Chatbot @Cubastion", layout = "wide")
st.title("<Cubastion's HR Chatbot>")
...
# greeting = "Hello! I'm the Cubastion HR Chatbot, ready to answer your queries regarding Cubastion's HR policies!"
